...
function Services() {
    ...
    const services_text1_p1 =  `اگر به دنبال مشاوره کنکور با رتبه برترها هستید، جای درستی آمده‌اید!
                                گروه مشاوره تحصیلی کنکور مشاوریوم در حال حاضر دارای بیش از 200+ مشاور کنکور رتبه برتر است.
                                نتیجه تلاش این مشاوران در طی سال‌های اخیر +15 هزار نفر قبولی و
                                +3000 نفر رتبه برتر بوده است. خدمات مشاوره‌ای ما برای رشته‌های ریاضی،
    ...
    const services_text5_p1 =  `موسسه مشاوره کنکور نوتروفیل با تجربه‌ای که در طی این سال‌ها به دست آورده،
                ...
                <section className='sv-container' style={{marginBottom: "50px"}}>
                    <div className='sv-text-container sv-flex-col' id="fourthText">
                        ...
                        <Slide direction="right" timeout={slide_timeout + 100} in={fourthTextVisible}>
                            <p style={{margin: "0 3%"}}>{services_text4_p1}</p>
                        </Slide>
                    </div>
                </section>
                <section className='sv-container' style={{marginBottom: "50px"}}>
